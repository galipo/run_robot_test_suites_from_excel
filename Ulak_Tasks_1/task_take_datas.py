...
wb = load_workbook("RobotTestSuitesParamsList(Sayfa1).xlsx")
ws = wb.active
...
list=[]
while i<=19:
    list.append(ws.cell(2,i).value)    #taking data and adding a list from excel file         
    i=i+1
...
f.write('-i '+str(string[0])+'\n')
f.write('-i '+str(string[1])+'\n')
f.write('-i '+str(string[2])+'\n')
